...
# eCommerce's Payment Methods

eCommerce supports automatic (payment gateways) and manual payment methods.
...
eCommerce's manual payment methods include Cash on Delivery (COD) option.
...
Learn more about how to [enable Cash on Delivery](cash-on-delivery) on your store.

...
To add a new product to your eCommerce store:

1. On your **eCommerce admin**, tap **Products** under the **Catalog** section on the left menu.
2. Click on the **Create Product** button.

## Creating and Optimizing Product Pages

eCommerce allows you to add and optimize your product page with diverse features.
...
2. Add **product variations** if your product comes in different variations, such as different colors or sizes. For each variation, you can include its respective **media files** and **attributes like color, size, weight, and or material**.

3. Define the **stock quantity** for your product so that customers know how many items are available for purchase.

4. Add your product to **product collections** to help customers easily find it when browsing your online store. You can **create collections** based on categories, promotions (i.e., "New Year sale", "Summer sale", "Best sellers"), or any other criteria you choose.
...
6. Finally, **optimize your product for search engines** to improve its visibility to potential customers. Include relevant keywords in your **meta title and description**, and make sure your media files are labeled correctly.
...
You can optimize your product description readability by adding headings, bullet lists, making some features **bold** or *italic*.

eCommerce allows you to add product descriptions with 2000 characters or less.
...
- **File format**: eCommerce allows you to add the product images in .jpg and .png formats. If you have another format, you can convert it to one of these formats online.
...
- **Price**: The product price is the price set for the purchase of a product. This price is determined by taking into account the cost of the product, the labor involved in the production process, the marketing of the product, and other factors.
...
For example, let's say you sell t-shirt in 3 sizes (small, medium, and large) and 2 colors (red and yellow).
...
If your product is variable, you can create a range of distinct variations by utilizing attributes and their respective values. This feature allows you to offer different versions of the same product, varying by attributes such as color, size, material, and more.
...
2. You will see pre-created attributes such as color and size. You can rename them by typing the desired attribute name in the attribute input box.

3. To add new attributes, simply click on the **"+ Add option"** hypertext and enter the name of the attribute.

4. To add values for the attributes, such as yellow, white, and black for color, simply enter the values in the input box and hit Enter.
...
If you haven't created a product collection, navigate to the **Products → Collections** to create one.

Read more about how to create [product collections](product-collections).
...
The weight you provide plays a vital role in calculating accurate shipping rates for customers during the checkout process. Additionally, it ensures that appropriate pricing labels are generated during fulfillment, allowing for seamless and efficient order processing.
